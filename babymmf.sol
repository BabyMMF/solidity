...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x97749c9B61F878a880DfE312d2594AE07AEd7656); // mmf
...
contract BabyMM is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABYMMF";
    string constant _symbol = "BABYMMF";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x145677FC4d9b8F19B5D56d1820c48e0443049a30; //CroMeerkat router
    address RewardToken = 0x97749c9B61F878a880DfE312d2594AE07AEd7656; // mmf
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newPoorMe) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(poorMe).call{value: devShare, gas: 30000}("");
